...
class MxGoogLeNet:
    ...
    def conv_module(data, num_filter, kernel_x, kernel_y, stride=(1, 1), pad=(0, 0), stage='', act_type='relu'):
        ...
        act_fn = mx.sym.Activation(data=conv, act_type=act_type, name=stage+'_act') if act_type == 'relu' else mx.sym.LeakyReLU(data=conv, act_type=act_type, name=stage+'_act')
    ...
    def inception_module(data, num_1x1, num_3x3_reduce, num_3x3, num_5x5_reduce, num_5x5, num_1x1_proj, stage=''):
        ...
        conv_r3x3 = MxGoogLeNet.conv_module(data, num_3x3_reduce, 1, 1, stage=stage+'_branch_2_reduce')
        ...
        conv_r5x5 = MxGoogLeNet.conv_module(data, num_5x5_reduce, 1, 1, stage=stage+'_branch_3_reduce')
        ...
        pool = mx.sym.Pooling(data=data, kernel=(3, 3), pool_type='max', stride=(1, 1), pad=(1, 1), name=stage+'_branch_4_pool')
