# USAGE
# python test_googlenet.py --checkpoints checkpoints --prefix googlenet --epoch-number 50
...
ap.add_argument('-p', '--prefix', required=True, default='googlenet', help='prefix of filename that mxnet creates')
