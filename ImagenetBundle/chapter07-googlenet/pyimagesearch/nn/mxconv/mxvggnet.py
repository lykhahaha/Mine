...
class MxVGGNet:
    ...
    def build(classes):
        ...
        # Block #1: (Conv -> PReLU -> BN) * 2 -> MaxPool -> Dropout
        ...
        pool1 = mx.sym.Pooling(data=bn1_2, kernel=(2, 2), pool_type='max', stride=(2, 2), name='pool1')
        do1 = mx.sym.Dropout(data=pool1, p=0.25)

        # Block #2: (Conv -> PReLU -> BN) * 2 -> MaxPool -> Dropout
        ...
        pool2 = mx.sym.Pooling(data=bn2_2, kernel=(2, 2), pool_type='max', stride=(2, 2), name='pool2')
        do2 = mx.sym.Dropout(data=pool2, p=0.25)

        # Block #3: (Conv -> PReLU -> BN) * 3 -> MaxPool -> Dropout
        ...
        pool3 = mx.sym.Pooling(data=bn3_3, kernel=(2, 2), pool_type='max', stride=(2, 2), name='pool3')
        do3 = mx.sym.Dropout(data=pool3, p=0.25)

        # Block #4: (Conv -> PReLU -> BN) * 3 -> MaxPool -> Dropout
        ...
        pool4 = mx.sym.Pooling(data=bn4_3, kernel=(2, 2), pool_type='max', stride=(2, 2), name='pool4')
        do4 = mx.sym.Dropout(data=pool4, p=0.25)

        # Block #5: (Conv -> PReLU -> BN) * 3 -> MaxPool -> Dropout
        ...
        pool5 = mx.sym.Pooling(data=bn5_3, kernel=(2, 2), pool_type='max', stride=(2, 2), name='pool5')
