...
class DeeperGoogLeNet:
    @staticmethod
    def conv_module(x, K, k_x, k_y, stride, chan_dim, padding='same', reg=5e-4, name=None):
    ...
    @staticmethod
    def inception_module(x, num_1x1, num_3x3_reduce, num_3x3, num_5x5_reduce, num_5x5, num_1x1_proj, chan_dim, stage, reg=5e-4):
    ...
    @staticmethod
    def build(width, height, depth, classes, reg=5e-4):
