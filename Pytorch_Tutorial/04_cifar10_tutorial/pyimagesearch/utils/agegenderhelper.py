...
class AgeGenderHelper:
    ...
    def plot_confusion_matrix_from_data(config, y_true, y_pred, le, save_path, figsize=(12, 9)):
        if config.DATASET_TYPE == 'age':
            ...
            figsize=(5, 5)
        AgeGenderHelper.plot_confusion_matrix_from_transformed_data(y_true, y_pred, labels, save_path, figsize)

    @staticmethod
    def plot_confusion_matrix_from_transformed_data(y_true, y_pred, labels, save_path, figsize=(12, 9)):
