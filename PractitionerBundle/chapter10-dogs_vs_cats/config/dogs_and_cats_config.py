...
# define path to the output directory used for storing plots, classification reports, etc
OUTPUT_PATH = 'output'

# define public test set
PUBLIC_TEST_SET = '../test1'

# define the path to pubic test set HDF5 files
PUBLIC_TEST_HDF5 = '../public_test.hdf5'